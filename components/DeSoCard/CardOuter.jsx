...
export default function CardOuter({ rootRef }) {
  ...
  return (
    <div id="desoPost" ref={rootRef} style={{ aspectRatio: size.ratio, background: `linear-gradient(to bottom right, ${gradient.from}, ${gradient.to})`,}} className="flex w-full py-8 px-[2px] h-full items-center justify-center overflow-hidden rounded-xl leading-normal shadow-md">
